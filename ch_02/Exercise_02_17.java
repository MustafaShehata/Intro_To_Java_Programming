...
public class Exercise_02_17 {
    public static void main(String[] args) {
        // Create an object from Scanner Class to get an input from keyboard
        Scanner input = new Scanner(System.in);
        
        // Prompt the user to enter temperature between -58F and 41F
        System.out.print("Enter the temperature in Fahrenheit between -58°F and 41°F: ");
        double temperature = input.nextDouble();
        
        // Prompt the user to enter the wind speed greater than or equal to 2
        ...
        // Display results
        System.out.printf("The wind chill index is %7.5f\n", windChillTemperature);
    }
